<?
    while ($dados_vendidos = mysqli_fetch_assoc($query_vendidos)) {
        $nome_produto = $dados_vendidos['produto'];
        $nome_produto = ucwords($nome_produto);
        $preco = $dados_vendidos['preco'];
        $por = $dados_vendidos['por'];
        $qtd = $dados_vendidos['qtd'];
        $cor = $dados_vendidos['cor'];
        $tamanho = $dados_vendidos['tamanho'];
        $id = $dados_vendidos['id'];
        $sku = $dados_vendidos['sku'];
        $sistema = $dados_vendidos['sistema'];
        $url_amigavel = $dados_vendidos['url_amigavel'];
        $forma = $dados_vendidos['forma'];
        $img = $dados_vendidos['img'];
        $img_secundaria = $dados_vendidos['img_secundaria'];
        $pagina_referencia = 'produtos';
        
        $url = $url_loja."/produto/".$url_amigavel;
        
        if ($dados_vendidos['img'] == '') {
