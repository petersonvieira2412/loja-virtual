...
class LenientParsingTest extends \PHPUnit_Framework_TestCase {
	...
	*/
	public function testFaultToleranceOff() {
		$sFile = dirname(__FILE__) . '//www.beermetria.com.br/files' . DIRECTORY_SEPARATOR . "-fault-tolerance.css";
	...
	*/
	public function testEndToken() {
		$sFile = dirname(__FILE__) . '//www.beermetria.com.br/files' . DIRECTORY_SEPARATOR . "-end-token.css";
		$oParser = new Parser(file_get_contents($sFile), Settings::create()->beStrict());
		$oParser->parse();
	}
	...
	*/
	public function testEndToken2() {
		$sFile = dirname(__FILE__) . '//www.beermetria.com.br/files' . DIRECTORY_SEPARATOR . "-end-token-2.css";
		$oParser = new Parser(file_get_contents($sFile), Settings::create()->beStrict());
		$oParser->parse();
	}
	...
	public function testCaseInsensitivity() {
		$sFile = dirname(__FILE__) . '//www.beermetria.com.br/files' . DIRECTORY_SEPARATOR . "case-insensitivity.css";
