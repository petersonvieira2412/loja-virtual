                        ...
                        if(need_sidebar === 'true') {
                            $.extend(params.desktop, {
                                move: [
                                    ...
                                    {
                                        elem: '[data-js-sticky-replace-element="conta"]',
                                        to: '[data-js-sticky-replace-here="conta"]'
                                    },
                                    {
                                    ...
                                    {
                                        elem: '[data-js-sticky-replace-element="favoritos"]',
                                        to: '[data-js-sticky-replace-here="favoritos"]'
                                    },
                                    {
                                        elem: '[data-js-sticky-replace-element="pesquisa"]',
                                        to: '[data-js-sticky-replace-here="pesquisa"]'
                                    }
                                ]
                            });
                        }
