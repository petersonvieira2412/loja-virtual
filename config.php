...
$conexao = mysqli_connect("localhost", "imperiosofas_loja", '}#4!,xG(;4L4', "imperiosofas_loja");
mysqli_set_charset($conexao,"utf8");
if (!$conexao) { die("Falha na conexao: " . mysqli_connect_error()); }

$path = "/home/imperiosofas/public_html/";
$set_max_bytes_allowed = "90000000";

$psite = "https://www.imperiosofas.com.br";
$sitenome = explode('.', $psite);
$sitenome = $sitenome[1];
$pnome = "Império Sofás";
$ppara = "contato@imperiosofas.com.br.br";
$pdescricao = "Entregamos em todo Vale do Paraíba com pagamento em até 10x no cartão - ".$pnome;
$purl_amigavel = 'imperio-sofas';

$google_site_key = "6Le-UhklAAAAACbIPwDdYzO8WdgHIdqzdYpcMijw";
$google_secret_key = "6Le-UhklAAAAAOQueK3zClAZtz8uFVnxIEyCEJtA";
