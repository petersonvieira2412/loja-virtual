...
if (!isset($titulo_site) || $titulo_site==''){$titulo_site = 'Produtos - '.$nome_loja;}
                ...
                <div class="collections__body col pb-25">
                    <div id="theme-section-collection-body" class="theme-section">
                        <div data-section-id="collection-body" data-section-type="collection-body">
                            <div class="collection-body js-products-view">
                                    <div class="collection-control mb-25 mb-lg-30 border-bottom">
                                        <div class="row">
                                            ...
                                            <?if (isset($url_amigavel_cat) AND $url_amigavel_cat!=''){?>
                                                        ...
                                                        <div class="select position-relative js-dropdown js-select">
                                                            <div class="d-flex align-items-center" data-js-dropdown-button>
                                                                ...
                                                                <select name="ordenar" class="p-0 pr-25 mb-0 border-0 cursor-pointer" id="ordenar" style="min-width: 100px;">
                                                                    <option value="<?=$url_loja;?>/categoria/<?=$url_amigavel_cat;?>/<?=$pagina;?>/0" <?echo (($ordenar=='0')?'selected':'');?>>Menor Preço</option>
                                                                    <option value="<?=$url_loja;?>/categoria/<?=$url_amigavel_cat;?>/<?=$pagina;?>/1" <?echo (($ordenar=='1')?'selected':'');?>>Maior Preço</option>
                                                                    <option value="<?=$url_loja;?>/categoria/<?=$url_amigavel_cat;?>/<?=$pagina;?>/2" <?echo (($ordenar=='2')?'selected':'');?>>Nome A-Z</option>
                                                                    <option value="<?=$url_loja;?>/categoria/<?=$url_amigavel_cat;?>/<?=$pagina;?>/3" <?echo (($ordenar=='3')?'selected':'');?>>Nome Z-A</option>
                                                                    <option value="<?=$url_loja;?>/categoria/<?=$url_amigavel_cat;?>/<?=$pagina;?>/4" <?echo (($ordenar=='4')?'selected':'');?>>Mais Vistos</option>
                                                                    <option value="<?=$url_loja;?>/categoria/<?=$url_amigavel_cat;?>/<?=$pagina;?>/5" <?echo (($ordenar=='5')?'selected':'');?>>Mais Vendidos</option>
                                                                </select>
                                                            ...
                                                            <div class="select__dropdown dropdown position-lg-absolute d-none top-lg-100 left-lg-0" data-js-dropdown data-js-select-dropdown>
                                                                <div class="px-15 pb-30 py-lg-15">
                                                                    <a href="<?=$url_loja;?>/categoria/<?=$url_amigavel_cat;?>/<?=$pagina;?>/0" title="Menor Preço"><span data-value="Menor Preço" <?echo (($ordenar=='0')?'class="selected"':'');?>>Menor Preço</span></a>
                                                                    <a href="<?=$url_loja;?>/categoria/<?=$url_amigavel_cat;?>/<?=$pagina;?>/1" title="Maior Preço"><span data-value="Maior Preço" <?echo (($ordenar=='1')?'class="selected"':'');?>>Maior Preço</span></a>
                                                                    <a href="<?=$url_loja;?>/categoria/<?=$url_amigavel_cat;?>/<?=$pagina;?>/2" title="Nome A-Z"><span data-value="Nome A-Z" <?echo (($ordenar=='2')?'class="selected"':'');?>>Nome A-Z</span></a>
                                                                    <a href="<?=$url_loja;?>/categoria/<?=$url_amigavel_cat;?>/<?=$pagina;?>/3" title="Nome Z-A"><span data-value="Nome Z-A" <?echo (($ordenar=='3')?'class="selected"':'');?>>Nome Z-A</span></a>
                                                                    <a href="<?=$url_loja;?>/categoria/<?=$url_amigavel_cat;?>/<?=$pagina;?>/4" title="Mais Vistos"><span data-value="Mais Vistos" <?echo (($ordenar=='4')?'class="selected"':'');?>>Mais Vistos</span></a>
                                                                    <a href="<?=$url_loja;?>/categoria/<?=$url_amigavel_cat;?>/<?=$pagina;?>/5" title="Mais Vendidos"><span data-value="Mais Vendidos" <?echo (($ordenar=='5')?'class="selected"':'');?>>Mais Vendidos</span></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <?
                                    ...
                                    $cmd1 = "SELECT categoria, id, img, url_amigavel from categorias WHERE status='a' AND categoria_pai='".$categoria."' ORDER BY categoria ASC";
									...
									$categoria = ($categoria=='')?0:$categoria;
                                	$cmd = "SELECT categoria, url_amigavel ,id, img from categorias WHERE status='a' AND categoria_pai='".$categoria."' ORDER BY categoria ASC";
									...
									?>
									    <div class="list-collections mb-40 mb-lg-30">
        									...
        									if ($categoria<1 AND $num_banner>0){
                                                $contador=0;
                                                ...
                                                while ($dadosV = mysqli_fetch_assoc($query)) {
                                                    $nome_catV = $dadosV['categoria'];
                                                    $id_catV = $dadosV['id'];
                                                    $imagem = $dadosV['img'];
                                                    $url_amigavel_cat = $dadosV['url_amigavel'];
            
                                                    //imagem
                                                    if ($imagem=='') {
                                                        $img = $url_loja.'/assets/img/categorias/sem_imagem.jpg';
                                                    }
                                                    elseif (file_exists('assets/img/categorias/'.$imagem)) {
                                                        $img = $url_loja.'/assets/img/categorias/'.$imagem; 
                                                    }
                                                    else{
                                                        $img = $url_loja.'/assets/img/categorias/sem_imagem.jpg';
                                                    }                                                
                                                    
                                                    $link = $url_loja."/categoria/".$url_amigavel_cat;
            								    ?>
                                                    <div class="col-md-4 mb-25 carrossel-produtos-home width-produtos" style="max-width: 80%;">
                                                        <div class="product-collection d-flex flex-column" data-js-product data-js-product-json-preload data-product-handle="<?=$id;?>" data-product-variant-id="<?=$id;?>">
                                                            <div class="div-img-carrossel product-collection__image product-image product-image--hover-emersion-z position-relative w-100 js-product-images-navigation js-product-images-hovered-end js-product-images-hover">
                                                                <a href="<?=$link;?>" title="<?=$nome_catV;?>" class="d-block cursor-default div-img-carrossel" data-js-product-image>
                                                                    <div class="rimage">
                                                                        <img src="<?=$img;?>" data-master="<?=$img;?>" data-aspect-ratio="" data-srcset="<?=$img;?>" data-image-id="<?=$id;?>" alt="<?=$nome_catV;?>" title="<?=$nome_catV;?>" class="rimage__img rimage__img--contain rimage__img--fade-in lazyload">
                                                                    </div>
                                                                </a>
                                                            </div>
                                                            <div class="product-collection__content d-flex flex-column align-items-start pt-15 pl-5 pr-5">
                                                                <div class="product-collection__title mb-3 w-100">
                                                                    <h4 class="h6 m-0">
                                                                        <a href="<?=$link;?>" title="<?=$nome_catV;?>" class="titulo-produto"><?echo mb_strimwidth("$nome_catV", 0, 80, "...");?></a>
                                                                    </h4>
                                                                </div>
                                                                <form method="post" action="" accept-charset="UTF-8" class="d-flex flex-column w-100 m-0" enctype="multipart/form-data" data-js-product-form="">
                                                                    ...
                                                                    <div class="product-collection__buttons d-flex flex-column flex-lg-row align-items-lg-center flex-wrap my-lg-15 justify-content-center">
                                                                        <div class="product-collection__buttons-section d-flex">
                                                                            <a href="<?=$link;?>" title="VER PRODUTOS" class="btn btn--status btn--animated botao-detalhes" style="border-radius:0;">
                                                                                <span class="d-flex flex-center">
                                                                                    ...
                                                                                    <span class="btn__text">VER PRODUTOS</span>
                                                                                </span>
                                                                            </a>
                                                                        </div>
                                                                    </div>
								    ...
								    <div class="collection-products" data-js-products>
                                        <div class="row" data-js-collection-replace="products" data-js-collection-replace-method="add" style="display: flex;">
                                            ...
                                            if (isset($filtro) AND $filtro!=''){
                                                ...
                                                $result = "SELECT p.id FROM produtos AS p INNER JOIN estoque AS e ON (p.id=e.id_produto) WHERE p.categoria='$categoria' AND p.status='a' $filtro_preco $filtro GROUP BY p.id";
                                            }else{
                                                if (isset($_SESSION['preco']) AND $_SESSION['preco']!=''){
                                                    $preco_min = str_replace(",", ".", str_replace(".", "", $_SESSION['preco'][0]));
                                                    $preco_max = str_replace(",", ".", str_replace(".", "", $_SESSION['preco'][1]));
                                                ...
                                                $result = "SELECT id,img,produto,preco,por,sku FROM produtos WHERE categoria='".$categoria."' AND status='a' $filtro_preco";
                                            }
                                            ...
                                            if (isset($filtro) AND $filtro!=''){
                                                $result = "SELECT p.id,p.img,p.img_secundaria,p.produto,p.preco,p.por,p.sku,p.sistema,p.link_compra,p.qtd,p.url_amigavel FROM produtos AS p INNER JOIN estoque AS e ON (p.id=e.id_produto) WHERE p.categoria='$categoria' AND p.status='a' $filtro_preco $filtro GROUP BY p.id $order limit $incio, $quantidade_pg";
                                            }else{
                                                $result = "SELECT id,img,img_secundaria,produto,preco,por,sku,sistema,link_compra,qtd,url_amigavel FROM produtos WHERE categoria='$categoria' AND status='a' $filtro_preco $order limit $incio, $quantidade_pg";
								            }
                                            $resultado = mysqli_query($conn, $result);
                                            $total = mysqli_num_rows($resultado);
                                            ...
                                            ?>
                                                <div class="col-md-4 mb-25 carrossel-produtos-home width-produtos" style="max-width: 80%;">
                                                    <div class="product-collection d-flex flex-column" data-js-product data-js-product-json-preload data-product-handle="<?=$id;?>" data-product-variant-id="<?=$id;?>">
                                                        ...
                                                        <div class="product-collection__content d-flex flex-column align-items-start pt-15 pl-15 pr-15">
                                                            <div class="product-collection__title mb-3 w-100">
                                                                <h4 class="h6 m-0">
                                                                    <a href="<?=$url;?>" title="<?=$nome_produto;?>" class="titulo-produto"><?echo mb_strimwidth("$nome_produto", 0, 80, "...");?></a>
                                                                </h4>
                            ...
                            <?if ($total1<1 AND $total>0 AND $temproduto==true AND isset($url_amigavel_cat)){
                                                    ...
                                                    <?if ($categoria!='') {
                                                        if($pagina_anterior!=0){ ?>
                                                            <li class="page-item" style="padding:0;">
                                                                <a class="page-link" href="<?=$url_loja;?>/categoria/<?=$url_amigavel_cat;?>/<?=$pagina_anterior;?>/<?=((isset($_GET['ordenar']) AND $_GET['ordenar']!='')?$ordenar:'');?>" title="Anterior">Anterior</a>
                                                            </li>
                                                            <?if($diferenca_anterior>2){?>
                                                                <li class="page-item" style="padding:0;">
                                                                    <a class="page-link" href="<?=$url_loja;?>/categoria/<?=$url_amigavel_cat;?>/1/<?=((isset($_GET['ordenar']) AND $_GET['ordenar']!='')?$ordenar:'');?>" title="Página 1">1</a>
                                                                </li>
                                                        ...
                                                        ?>
                                                            <li class="page-item <?=$class?>" style="padding:0;">
                                                                <a class="page-link" href="<?=$url_loja;?>/categoria/<?=$url_amigavel_cat;?>/<?=$i;?>/<?=((isset($_GET['ordenar']) AND $_GET['ordenar']!='')?$ordenar:'');?>" title="Página <?=$i;?>"><?=$i;?></a>
                                                            </li>
                                                        <?}}}
                                                        if($pagina_posterior<=$num_pagina){?>
                                                            <?if($diferenca_posterior>1){?>
                                                                ...
                                                                <li class="page-item" style="padding:0;">
                                                                    <a class="page-link" href="<?=$url_loja;?>/categoria/<?=$url_amigavel_cat;?>/<?=$num_pagina;?>/<?=((isset($_GET['ordenar']) AND $_GET['ordenar']!='')?$ordenar:'');?>" title="Página <?=$num_pagina;?>"><?=$num_pagina;?></a>
                                                                </li>
                                                            <?}?>
                                                            <li class="page-item" style="padding:0;">
                                                                <a class="page-link" href="<?=$url_loja;?>/categoria/<?=$url_amigavel_cat;?>/<?=$pagina_posterior;?>/<?=((isset($_GET['ordenar']) AND $_GET['ordenar']!='')?$ordenar:'');?>" title="Próximo">Próximo</a>
                                                            </li>
                                                        <?}
                                                    }?>
                                                </ul>
