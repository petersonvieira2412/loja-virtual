...
if ($acao=="gravar") {
    ...
    if (!mysqli_query($conexao, $insere)) {  
      die('Erro: '.mysqli_error($conexao)); 
        ...
        if (isset($_POST['img_secundaria']) AND $_POST['img_secundaria']!='' AND $_POST['img_destaque']!=$dados_imagens['img_secundaria']){
            $nome = UrlAmigavel($produto);
            if ($nome=="") { $nome=$url_amigavel_loja; }
            $aleatorio = rand(1,999999);
                                                                                            ...
                                                                                            <div class="image_area">
                                                            							        <label for="upload_img_cor_<?=$contador;?>" style="width: 100%; display: flex; align-items: center;align-items: flex-start;">
                                                                							        <div class="col-md-2 padding-img-upload">
                                                                    								    ...
                                                                    								    <input type="hidden" name="img_cor[]" id="img_cor_<?=$contador;?>" value="<?=((isset($dados['img']) AND file_exists($img_cor_exibe))?$img_cor_exibe:'');?>"/>
                                                                    								</div>
                                                                    								<div class="col-md-10">
          ...
          <tbody>
              ...
              while ($dados = mysqli_fetch_assoc($query)) {
                ...
                <tr class="<?=$classe;?>">
                    <td class="center">
                        <?=$id;?>
                        <?echo((isset($sku) AND $sku!='')?'<br><b>SKU:</b> '.$sku:'');?>
                    </td>
