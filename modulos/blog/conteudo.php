  ...
  if ($acao=="gravar") { 
	...
	if (!mysqli_query($conexao, $insere)) {  
		...
		if (isset($_POST['img_destaque']) AND $_POST['img_destaque']!=''){
			...
			$nome = "blog-".$ultimo_id."-".$nome."-".$aleatorio.".jpg";
            ...
            mysqli_query($conexao, "UPDATE blog SET img='".$nome."' WHERE id='".$ultimo_id."' ")  or die(mysqli_error());
		}
		
		if (isset($_POST['img_interna']) AND $_POST['img_interna']!=''){
		    $caminho = "../assets/img/".$pagina_referencia."/".$ultimo_id."/";
		    
		    $nome_interna = UrlAmigavel($titulo);
			$aleatorio = rand(1,999999);
			$nome_interna = "blog-".$ultimo_id."-".$nome_interna."-".$aleatorio.".jpg";
			
            if (!is_dir($caminho)){ 
                mkdir("$caminho", 0755);
            }
            
            copy($_POST['img_interna'], $caminho.$nome_interna);
            unlink($_POST['img_interna']);
            
            mysqli_query($conexao, "UPDATE blog SET img_interna='".$nome_interna."' WHERE id='".$ultimo_id."' ")  or die(mysqli_error());
		}
		
	}
	
    echo "<script>alert('Blog cadastrado com sucesso!')</script>";
            ...
            <div class="panel-body">
              ...
              <br>
                    ...
                    <div class="form-group">
                        <div class="image_area">
							<label for="upload_destaque" style="width: 100%; display: flex; align-items: center;">
							    <div class="col-md-3">
    								<img src="../../assets/img/blog/sem_imagem.jpg" id="uploaded_destaque" class="img-responsive" style="border: 1px solid #eee;"/>
    								<div class="overlay">
    									<div class="text"><i class="fa fa-plus"></i></div>
    								</div>
    								<input type="file" name="upload_destaque" class="upload_image" id="upload_destaque" style="display:none;">
    								<input type="hidden" name="img_destaque" id="img_destaque" value=""/>
							    </div>
							    <div class="col-md-9">
							        <div class="col-md-12">
							            IMAGEM DESTAQUE (1000x1000 pixels)
							        </div>
							        <div class="col-md-12">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="image_area">
							<label for="upload_interna" style="width: 100%; display: flex; align-items: center;">
							    <div class="col-md-3">
    								<img src="../../assets/img/blog/sem_imagem.jpg" id="uploaded_interna" class="img-responsive" style="border: 1px solid #eee;"/>
    								<div class="overlay">
    									<div class="text"><i class="fa fa-plus"></i></div>
    								</div>
    								<input type="file" name="upload_interna" class="upload_image" id="upload_interna" style="display:none;">
    								<input type="hidden" name="img_interna" id="img_interna" value=""/>
							    </div>
							    <div class="col-md-9">
							        <div class="col-md-12">
							            IMAGEM INTERNA (900x500 pixels)
							        </div>
							        <div class="col-md-12">
							            <button type="button" onclick="$('#upload_destaque').click();" class="btn btn-success" style="line-height: 28px; font-size: 11px;"><i class="fa fa-check" style="font-size: 12px;"></i> Adicionar </button>
							        </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="image_area">
							<label for="upload_destaque" style="width: 100%; display: flex; align-items: center;">
							    <div class="col-md-3">
    								<img src="<?=$imagem_exibe;?>" id="uploaded_destaque" class="img-responsive" style="border: 1px solid #eee;"/>
    								<div class="overlay">
    									<div class="text"><i class="fa fa-plus"></i></div>
    								</div>
    								<input type="file" name="upload_destaque" class="upload_image" id="upload_destaque" style="display:none;">
							    ...
							    <div class="col-md-9">
							        ...
							        <div class="col-md-12">
							            <button type="button" onclick="$('#upload_destaque').click();" class="btn btn-success"><i class="fa fa-check"></i> Adicionar </button>
							        </div>
							    </div>
							</label>
    					</div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="image_area">
							<label for="upload_interna" style="width: 100%; display: flex; align-items: center;">
							    <div class="col-md-3">
    								<img src="<?=$imagem_interna;?>" id="uploaded_interna" class="img-responsive" style="border: 1px solid #eee;"/>
    								<div class="overlay">
    									<div class="text"><i class="fa fa-plus"></i></div>
    								</div>
    								<input type="file" name="upload_interna" class="upload_image" id="upload_interna" style="display:none;">
							    ...
							    <div class="col-md-9">
							        ...
							        <div class="col-md-12">
							            <button type="button" onclick="$('#upload_interna').click();" class="btn btn-success"><i class="fa fa-check"></i> Adicionar </button>
							        </div>
							    </div>
							</label>
    					</div>
      ...
      <div class="col-md-12">
        ...
        ?>
            ...
            <tr class="<?=$classe;?>">
              ...
              <td class="center"><?=strftime("%d de %B de %Y", strtotime($data));?></td>
              <td >
            	<div class="socials tex-center"> 
