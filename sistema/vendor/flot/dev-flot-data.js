...
$(document).ready(function() {
    ...
    function plot() {
        ...
        var plotObj = $.plot($("#flot-line-chart-plataforma"), [{
                data: sin,
                color:'#03A9F4',
                label: "sin(x)"
            }, {
            ...
            options);
        if (tipo===''){
            var plotObjE = $.plot($("#flot-line-chart-empreendimentos"), [{
                    data: sin,
                    color:'#03A9F4',
                    label: "sin(x)"
                }, {
...
$(function () {
    ...
    if (fb>0){
        var facebook = {label: 'Facebook', data: fb, color:'#03A9F4'};
        data.push(facebook);
    }
    if (insta>0){
        var instagram = {label: "Instagram", data: insta, color:'#F44336'};
        data.push(instagram);
    }
    if (si>0){
        var site = {label: "Site", data: si, color:'#FFC107'};
        data.push(site);
    }
    
    var plotObj = $.plot($("#flot-pie-chart-plataforma"), data, {
        series: {
            pie: {
                show: true
            }
    ...
    if (tipo===''){
        ...
        var adiciona = '';
        for (i=0; i<=total; i++){
            empreendimento[i] = document.getElementById('empreendimento_'+i).value;
            
            adiciona = {label: empreendimento[i], data: 20, color: '#03A9F4'};
            data.push(adiciona);
            console.log(data);
        }
        
        var plotObjE = $.plot($("#flot-pie-chart-empreendimentos"), data, {
            series: {
                pie: {
                    show: true
                }
