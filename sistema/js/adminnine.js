...
/* Toast message appends here at bosy tag */
 setTimeout(function(){
	  /*$('body').append('<? if (!isset($_SESSION["alterta_vb"])) { ?> <div class="alert alert-info toastupdates alert-dismissable"> <button type="button" class="close" data-dismiss="alert" aria-hidden="true">x</button> <strong>SEJA BEM VINDO!</strong><p>Desenvolvido por <a href="http://www.virtuabrasil.com.br" target="_blank" >Virtua Brasil</a>.</p></div> <? } ?>');*/
	  $('body').append('');
